...
if ($.global.hasOwnProperty ("initLog") && $.global.hasOwnProperty ("deleteEndnote") ) {
	initLog();
	app.doScript(checkAndStart, ScriptLanguage.JAVASCRIPT, ["deleteEndnote"], UndoModes.ENTIRE_SCRIPT, localize(px.ui.deleteEndnoteName));
}
else {
