...
if ($.global.hasOwnProperty ("initLog") && $.global.hasOwnProperty ("jumpBetweenMarkerAndNote") ) {
	initLog();
	app.doScript(checkAndStart, ScriptLanguage.JAVASCRIPT, ["jumpBetweenMarkerAndNote"], UndoModes.ENTIRE_SCRIPT, localize({en:"jumpBetweenMarkerAndNote",de:"jumpBetweenMarkerAndNote"}));
}
else {
