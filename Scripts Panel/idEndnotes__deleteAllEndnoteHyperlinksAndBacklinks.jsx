...
if ($.global.hasOwnProperty ("initLog") && $.global.hasOwnProperty ("deleteEndnoteHyperlinksAndBacklinks") ) {
	initLog();
	app.doScript(checkAndStart, ScriptLanguage.JAVASCRIPT, ["deleteEndnoteHyperlinksAndBacklinks"], UndoModes.ENTIRE_SCRIPT, localize({en:"deleteEndnoteHyperlinksAndBacklinks",de:"deleteEndnoteHyperlinksAndBacklinks"}));
}
else {
